...
function updateSolverStatus(status) {
    let colorClass = "bg-secondary";
    if (status === "SOLVING") colorClass = "bg-warning";
    else if (status === "NOT_SOLVING") colorClass = "bg-success";
...
$(document).ready(function () {
    ...
    $.getJSON("/evrp/score/" + solutionId, function (analysis) {
        ...
        $("#score_a").attr({
            "title": "Score Brakedown", "data-bs-content": ""
    ...
    $.getJSON("/evrp/" + solutionId, function (solution) {
        updateSolverStatus(solution.solverStatus);
