...
import lv.lu.eztf.dn.combopt.evrp.rest.exception.ErrorInfo;
import lv.lu.eztf.dn.combopt.evrp.rest.exception.ScheduleSolverException;
...
public class MeetingSchedulingResource {
    ...
    @Inject
    public MeetingSchedulingResource(SolverManager<Schedule, String> solverManager,
